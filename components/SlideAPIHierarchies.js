...
class SlideAPIHierarchies  extends React.Component {
  state = {
    loaded: false
  }
  componentDidMount () {
    ...
    const exampleCode = require("!raw-loader!./D3APIHierarchies.js")
...
export default withRouter(SlideAPIHierarchies);
