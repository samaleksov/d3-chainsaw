...
import responseXML from "!raw-loader!../public/response.xml"
import responseJSON from "!raw-loader!../public/response.json"
import responseCSV from "!raw-loader!../public/response.csv"
import responseTSV from "!raw-loader!../public/response.tsv"
  ...
  executeCode: function executeCode() {
    ...
    try {
      ...
      var require = function(module){
        ...
        return aFrameBmText;
        else if(module == "!raw-loader!../public/response.xml")
        return responseXML;
        else if(module == "!raw-loader!../public/response.tsv")
        return responseTSV;
        else if(module == "!raw-loader!../public/response.csv")
        return responseCSV;
        else if(module == "!raw-loader!../public/response.json")
        return responseJSON;
