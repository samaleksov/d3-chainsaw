...
var ForceDirectedGraph = function (_React$Component) {
  (0, _inherits3.default)(ForceDirectedGraph, _React$Component);

  function ForceDirectedGraph() {
    (0, _classCallCheck3.default)(this, ForceDirectedGraph);
    return (0, _possibleConstructorReturn3.default)(this, (ForceDirectedGraph.__proto__ || (0, _getPrototypeOf2.default)(ForceDirectedGraph)).apply(this, arguments));
  }
  ...
  (0, _createClass3.default)(ForceDirectedGraph, [{
    ...
    value: function componentDidMount() {
      ...
      var width = this.svgNode.clientWidth;
      var height = this.svgNode.clientHeight;
      ...
      var group = svg.append("g").attr("width", "100%").attr("height", "100%");

      var zoom = d3.zoom().scaleExtent([1, Infinity]).on("zoom", zoomed);
      ...
      d3.json("/miserables.json", function (error, graph) {
        ...
        var link = group.append("g").attr("class", "links").selectAll("line").data(graph.links).enter().append("line").attr("stroke", "#999").attr("stroke-opacity", 0.6).attr("stroke-width", function (d) {
          return Math.sqrt(d.value);
        });

        var node = group.append("g").attr("class", "nodes").selectAll("circle").data(graph.nodes).enter().append("circle").attr("r", 5).attr("stroke", "#fff").attr("stroke-width", "1.5px").attr("fill", function (d) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement("svg", { style: styles.svg, ref: function ref(node) {
...
exports.default = (0, _reactRouter.withRouter)(ForceDirectedGraph);
...
/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(101); if (makeExportsHot(module, __webpack_require__(2))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "ForceDirectedGraph.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
var _ForceDirectedGraph = __webpack_require__(601);

var _ForceDirectedGraph2 = _interopRequireDefault(_ForceDirectedGraph);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var SlideGraph = function (_React$Component) {
  (0, _inherits3.default)(SlideGraph, _React$Component);

  function SlideGraph() {
    (0, _classCallCheck3.default)(this, SlideGraph);
    return (0, _possibleConstructorReturn3.default)(this, (SlideGraph.__proto__ || (0, _getPrototypeOf2.default)(SlideGraph)).apply(this, arguments));
  }

  (0, _createClass3.default)(SlideGraph, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _Box2.default,
        { full: true, flex: true, style: { flex: 1 } },
        _react2.default.createElement(
          'h1',
          null,
          'Use it'
        ),
        _react2.default.createElement(_ForceDirectedGraph2.default, null)
      );
    }
  }]);
  return SlideGraph;
...
exports.default = (0, _reactRouter.withRouter)(SlideGraph);

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(101); if (makeExportsHot(module, __webpack_require__(2))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "SlideGraph.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(66)(module)))
