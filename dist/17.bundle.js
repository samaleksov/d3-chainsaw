...
var D3APIRequests = function (_React$Component) {
  (0, _inherits3.default)(D3APIRequests, _React$Component);

  function D3APIRequests() {
    (0, _classCallCheck3.default)(this, D3APIRequests);
    return (0, _possibleConstructorReturn3.default)(this, (D3APIRequests.__proto__ || (0, _getPrototypeOf2.default)(D3APIRequests)).apply(this, arguments));
  }

  (0, _createClass3.default)(D3APIRequests, [{
    key: "componentDidMount",
    value: function componentDidMount() {

      var results = d3.select("#results");

      d3.xml('/response.xml', function (error, data) {
        if (error) throw error;
        var name = d3.select(data).select("name").text();
        var age = d3.select(data).select("age").text();

        var rawFile = __webpack_require__(715);
      ...
      d3.csv('/response.csv', function (error, data) {
        if (error) throw error;
        var rawFile = __webpack_require__(712);
        results.append("p").text("CSV");
        results.append("pre").style("white-space", "pre-wrap").text("" + rawFile);
        results.append("p").text("" + (0, _stringify2.default)(data));
      });

      d3.tsv('/response.tsv', function (error, data) {
        if (error) throw error;
        var rawFile = __webpack_require__(714);
        results.append("p").text("TSV");
        results.append("pre").style("white-space", "pre-wrap").text("" + rawFile);
        results.append("p").text("" + (0, _stringify2.default)(data));
      });

      d3.json('/response.json', function (error, data) {
        if (error) throw error;
        var rawFile = __webpack_require__(713);
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement("p", { id: "results" })
      );
    }
  }]);
  return D3APIRequests;
}(_react2.default.Component);

exports.default = (0, _reactRouter.withRouter)(D3APIRequests);

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(101); if (makeExportsHot(module, __webpack_require__(2))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "D3APIRequests.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
