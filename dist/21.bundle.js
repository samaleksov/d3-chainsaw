...
var SlideTopic = function (_React$Component) {
  (0, _inherits3.default)(SlideTopic, _React$Component);

  function SlideTopic() {
    (0, _classCallCheck3.default)(this, SlideTopic);
    return (0, _possibleConstructorReturn3.default)(this, (SlideTopic.__proto__ || (0, _getPrototypeOf2.default)(SlideTopic)).apply(this, arguments));
  }

  (0, _createClass3.default)(SlideTopic, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _Hero2.default,
          { backgroundImage: '/iStock_85558501_web.jpg' },
          _react2.default.createElement(
            'h1',
            null,
...
exports.default = (0, _reactRouter.withRouter)(SlideTopic);

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(101); if (makeExportsHot(module, __webpack_require__(2))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "SlideTopic.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
