...
var D3Force1 = function (_React$Component) {
  (0, _inherits3.default)(D3Force1, _React$Component);
  ...
  function D3Force1() {
    ...
    (0, _classCallCheck3.default)(this, D3Force1);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = D3Force1.__proto__ || (0, _getPrototypeOf2.default)(D3Force1)).call.apply(_ref, [this].concat(args))), _this), _this.links = [], _this.nodes = [{}], _this.addOne = function (coordinates) {
      _this.nodes.push({ x: coordinates[0], y: coordinates[1] });
  ...
  (0, _createClass3.default)(D3Force1, [{
    ...
    value: function componentDidMount() {
      ...
      this.link = this.group.append("g").attr("class", "links").selectAll("line").data(this.links).enter().append("line").attr("stroke", "#999").attr("stroke-opacity", 0.6).attr("stroke-width", function (d) {
        return Math.sqrt(d.value);
      });

      this.node = this.group.append("g").attr("class", "nodes").selectAll("circle").data(this.nodes);

      this.nodeEnter = this.node.enter().append("circle").attr("r", 5).attr("stroke", "#fff").attr("stroke-width", "1.5px").attr("fill", function (d) {
        return color(d.group);
      });
...
exports.default = (0, _reactRouter.withRouter)(D3Force1);
...
/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(101); if (makeExportsHot(module, __webpack_require__(2))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "D3Force1.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
