...
if (typeof AFRAME != "undefined") {
  ...
  if (!('gamepad-controls' in AFRAME.components)) AFRAME.registerComponent('gamepad-controls', _aframeGamepadControls2.default);

  if (!('text' in AFRAME.components)) __webpack_require__(669);

  if (!('bmfont-text' in AFRAME.components)) __webpack_require__(664);

  if (!('line' in AFRAME.components)) AFRAME.registerComponent('line', {
    schema: {
      color: { default: '#333' },
...
var WebVR = function (_React$Component) {
  (0, _inherits3.default)(WebVR, _React$Component);

  function WebVR() {
    (0, _classCallCheck3.default)(this, WebVR);
    return (0, _possibleConstructorReturn3.default)(this, (WebVR.__proto__ || (0, _getPrototypeOf2.default)(WebVR)).apply(this, arguments));
  }

  (0, _createClass3.default)(WebVR, [{
    ...
    value: function componentDidMount() {
      ...
      var nodes = [{ id: 1, value: 1, name: "Microsoft", description: "NASDAQ: MSFT" }, { id: 2, value: 2, name: "Amazon", description: "NASDAQ: AMZN" }, { id: 3, value: 3, name: "Samsung", description: "LON: BC94" }, { id: 4, value: 4, name: "Apple", description: "NASDAQ: AAPL" }, { id: 5, value: 5, name: "HTC", description: "TPE: 2498" }, { id: 6, value: 6, name: "Nokia", description: "NYSE: NOK" }, { id: 7, value: 7, name: "Kodak", description: "OTCMKTS: EKDKQ" }, { id: 8, value: 8, name: "Barnes & Noble", description: "NYSE: BKS" }, { id: 9, value: 9, name: "Foxconn", description: "TPE: 2354" }, { id: 10, value: 10, name: "Google", description: "NASDAQ: GOOGL" }, { id: 11, value: 11, name: "Inventec", description: "TPE: 2356" }, { id: 12, value: 12, name: "LG", description: "KRX: 003555" }, { id: 13, value: 13, name: "Motorola", description: "NYSE: MSI" }, { id: 14, value: 14, name: "ZTE", description: "SHE: 000063" }, { id: 15, value: 15, name: "RIM", description: "NASDAQ: BBRY" }, { id: 16, value: 16, name: "Qualcomm", description: "NASDAQ: QCOM" }, { id: 17, value: 17, name: "Oracle", description: "NYSE: ORCL" }, { id: 18, value: 18, name: "Sony", description: "NYSE: SNE" }, { id: 19, value: 19, name: "Ericsson", description: "NASDAQ: ERIC" }, { id: 20, value: 20, name: "Huawei", description: "Private" }];

      var links = [{ id: 1, source: 1, target: 2, type: "licensing", color: "blue" }, { id: 2, source: 1, target: 5, type: "licensing", color: "blue" }, { id: 3, source: 3, target: 4, type: "suit", color: "red" }, { id: 4, source: 1, target: 4, type: "suit", color: "red" }, { id: 5, source: 6, target: 4, type: "resolved", color: "green" }, { id: 6, source: 5, target: 4, type: "suit", color: "red" }, { id: 7, source: 7, target: 4, type: "suit", color: "red" }, { id: 8, source: 1, target: 8, type: "suit", color: "red" }, { id: 9, source: 1, target: 9, type: "suit", color: "red" }, { id: 10, source: 17, target: 10, type: "suit", color: "red" }, { id: 11, source: 4, target: 5, type: "suit", color: "red" }, { id: 12, source: 1, target: 11, type: "suit", color: "red" }, { id: 13, source: 3, target: 7, type: "resolved", color: "green" }, { id: 14, source: 12, target: 7, type: "resolved", color: "green" }, { id: 15, source: 15, target: 7, type: "suit", color: "red" }, { id: 16, source: 18, target: 12, type: "suit", color: "red" }, { id: 17, source: 7, target: 12, type: "resolved", color: "green" }, { id: 18, source: 4, target: 6, type: "resolved", color: "green" }, { id: 19, source: 16, target: 6, type: "resolved", color: "green" }, { id: 20, source: 4, target: 13, type: "suit", color: "red" }, { id: 21, source: 1, target: 13, type: "suit", color: "red" }, { id: 22, source: 13, target: 1, type: "suit", color: "red" }, { id: 23, source: 20, target: 14, type: "suit", color: "red" }, { id: 24, source: 19, target: 14, type: "suit", color: "red" }, { id: 25, source: 7, target: 3, type: "resolved", color: "green" }, { id: 26, source: 4, target: 3, type: "suit", color: "red" }, { id: 27, source: 7, target: 15, type: "suit", color: "red" }, { id: 28, source: 6, target: 16, type: "suit", color: "red" }];

      var hscale = d3.scaleLinear().domain([0, d3.max(data)]).range([0, 100]);

      var scene = d3.select("a-scene");

      var bars = scene.selectAll("a-box.bar").data(data);

      this.node = scene.select(".graph").selectAll("a-entity.node").data(nodes);

      this.link = scene.select(".graph").selectAll("a-entity.link").data(links);

      var nodeEnter = this.node.enter();

      var spheres = nodeEnter.append("a-entity").attr("geometry", "primitive: sphere").attr("radius", 2.5).classed("node", true);

      spheres.append("a-entity").attr("mixin", "lookAtCamera").attr("position", "0 0 4").attr("scale", "4 4 4").attr("text", function (d, i) {
        return "text: " + d.name;
      });

      spheres.attr('opacity', 0.5).on("click", function (d) {
        newBars.selectAll("a-entity").attr("text", function (monitor) {
          return "size: 8; text: " + (monitor == 2 ? d.name : d.description);
        });
      }).on("mouseenter", function () {
        if (this.hovering) return;
        this.hovering = true;
        d3.select(this).transition().duration(1000).attr("scale", 2);
      }).on("mouseleave", function () {
        this.hovering = false;
        d3.select(this).transition().attr("scale", 1);
      });

      var lines = this.link.enter().append("a-entity").classed("link", true).attr("line", function (d) {
        return "color: " + d.color + ";";
      });

      var simulation = (0, _d5.default)().force("link", d3.forceLink().id(function (d) {
        return d.id;
      })).force("center", d3.forceCenter()).force("x", d3.forceX()).force("y", d3.forceY()).force("charge", d3.forceManyBody());

      simulation.nodes(nodes).on("tick", function () {
        spheres.attr("position", function (d) {
          return d.x + " " + d.y + " " + d.z;
        });

        lines.attr("line", function (d) {
      ...
      var newBars = bars.enter().append("a-box").classed("bar", true);

      newBars.attr('position', function (d, i) {
        var y = 1 + hscale(d3.max(data)) / 2;
        var radius = 160;
        ...
        return x + " " + y + " " + z;
      }).attr('width', 0.5).attr('depth', 160).attr('height', function (d) {
        return hscale(d3.max(data));
        ...
        this.hovering = true;
        d3.select(this).transition().duration(1000).attr("metalness", 0.5).attr("width", 2);
      }).on("mouseleave", function (d, i) {
        console.log("leave", i, d);
        this.hovering = false;
        d3.select(this).transition().attr("metalness", 0).attr("width", 0.5);
      }).append("a-entity").attr("text", function (d, i) {
        return "size: 8; text: Screen " + i;
        ...
        var x = 0;
        var z = 0;
        var y = -((i == 0 ? i + 1 : i) / data.length) * 180;
        return x + " " + y + " " + z;
      });
    }
  }, {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "a-assets",
            null,
            _react2.default.createElement("a-mixin", { id: "lookAtCamera", "look-at": "#camera" })
          ),
          _react2.default.createElement(
            "a-entity",
            ...
            _react2.default.createElement(
              "a-entity",
              { "class": "graph" },
              _react2.default.createElement("a-entity", { mixin: "lookAtCamera", position: "-260 0 -560", text: "size: 45;text: Mobile Patent Suits" })
            )
          ),
          _react2.default.createElement("a-sky", { src: "/room_reception.jpg" }),
          _react2.default.createElement(
            "a-entity",
            { id: "camera", camera: "userHeight: 1.6", position: "0 0 60", "gamepad-controls": "flyEnabled: true", "look-controls": true, "wasd-controls": "fly: true; acceleration: 820" },
            _react2.default.createElement(
              "a-entity",
              { position: "0 0 -1",
              ...
              _react2.default.createElement("a-animation", { begin: "click", easing: "ease-in", attribute: "scale",
                fill: "backwards", from: "0.1 0.1 0.1", to: "1 1 1", dur: "150" }),
              _react2.default.createElement("a-animation", { begin: "cursor-fusing", easing: "ease-in", attribute: "scale",
...
exports.default = (0, _reactRouter.withRouter)(WebVR);
...
/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(101); if (makeExportsHot(module, __webpack_require__(2))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "WebVR.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
