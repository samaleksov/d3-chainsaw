...
var _regenerator = __webpack_require__(741);
...
var D3APIRandom = function (_React$Component) {
  (0, _inherits3.default)(D3APIRandom, _React$Component);

  function D3APIRandom() {
    (0, _classCallCheck3.default)(this, D3APIRandom);
    return (0, _possibleConstructorReturn3.default)(this, (D3APIRandom.__proto__ || (0, _getPrototypeOf2.default)(D3APIRandom)).apply(this, arguments));
  }

  (0, _createClass3.default)(D3APIRandom, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _marked = [randomUniform, randomNormal, randomLogNormal].map(_regenerator2.default.mark);

      var x = d3.scaleLinear().domain([0, 500]).range([0, 500]);
      var axis = d3.axisBottom().scale(x);

      var y = d3.scaleLinear().domain([500, 0]).range([0, 500]);
      var axisY = d3.axisLeft().scale(y);

      var selection = d3.select(this.refs.mainDiv).append("svg").attr("class", "axis").attr("width", 600).attr("height", 600);

      selection.append("g").attr("transform", "translate(50,550)").call(axis);

      selection.append("g").attr("transform", "translate(50,50)").call(axisY);

      function randomUniform(items) {
        var randomGen;
        return _regenerator2.default.wrap(function randomUniform$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                randomGen = d3.randomUniform(0, 501);
      ...
      var uniformData = (0, _from2.default)(randomUniform(50));

      selection.append("g").attr("transform", "translate(50,50)").selectAll("circle").data(uniformData).enter().append("circle").attr("r", 5).attr("fill", "red").attr("cx", function (d) {
        return x(d);
      }).attr("cy", function (d) {
        return y(d);
      });
      ...
      function randomNormal(items) {
        var randomGen;
        return _regenerator2.default.wrap(function randomNormal$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                randomGen = d3.randomNormal(250, 30);
      ...
      var normalData = (0, _from2.default)(randomNormal(50));

      selection.append("g").attr("transform", "translate(50,50)").selectAll("circle").data(normalData).enter().append("circle").attr("r", 3).attr("fill", "orange").attr("cx", function (d) {
        return x(d);
      }).attr("cy", function (d) {
        return y(d);
      });
      ...
      function randomLogNormal(items) {
        var randomGen;
        return _regenerator2.default.wrap(function randomLogNormal$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                randomGen = d3.randomLogNormal(0, 2);
      ...
      var logNormalData = (0, _from2.default)(randomLogNormal(50));

      selection.append("g").attr("transform", "translate(50,50)").selectAll("circle").data(logNormalData).enter().append("circle").attr("r", 1).attr("fill", "blue").attr("cx", function (d) {
        return x(d);
      }).attr("cy", function (d) {
        return y(d);
      });
    ...
    value: function render() {
      return _react2.default.createElement("div", { ref: "mainDiv" });
    }
  }]);
  return D3APIRandom;
}(_react2.default.Component);

exports.default = (0, _reactRouter.withRouter)(D3APIRandom);

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(101); if (makeExportsHot(module, __webpack_require__(2))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "D3APIRandom.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(80), __webpack_require__(0)))
