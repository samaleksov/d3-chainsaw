...
var SlideGandalf = function (_React$Component) {
  (0, _inherits3.default)(SlideGandalf, _React$Component);

  function SlideGandalf() {
    (0, _classCallCheck3.default)(this, SlideGandalf);
    return (0, _possibleConstructorReturn3.default)(this, (SlideGandalf.__proto__ || (0, _getPrototypeOf2.default)(SlideGandalf)).apply(this, arguments));
  }

  (0, _createClass3.default)(SlideGandalf, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(_Box2.default, { style: {
          backgroundImage: 'url(/gandalf.jpg)',
...
exports.default = (0, _reactRouter.withRouter)(SlideGandalf);

/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(101); if (makeExportsHot(module, __webpack_require__(2))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "SlideGandalf.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
