...
var BasicShapes = function (_React$Component) {
  (0, _inherits3.default)(BasicShapes, _React$Component);

  function BasicShapes() {
    (0, _classCallCheck3.default)(this, BasicShapes);
    return (0, _possibleConstructorReturn3.default)(this, (BasicShapes.__proto__ || (0, _getPrototypeOf2.default)(BasicShapes)).apply(this, arguments));
  }

  (0, _createClass3.default)(BasicShapes, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.svgSelection = d3.select(this.svgNode);

      this.svgSelection.append("line").attr("x1", 25).attr("y1", 25).attr("x2", 65).attr("y2", 65).attr("stroke-width", 3).attr("stroke", "black");

      var arc = d3.arc().innerRadius(0).outerRadius(40).startAngle(0).endAngle(Math.PI / 2);

      this.svgSelection.append("path").attr("transform", "translate(25 165)").attr("d", arc()).attr("stroke", "black");

      this.svgSelection.append("path").attr("d", d3.symbol().type(d3.symbolDiamond).size(1000)).attr("transform", "translate(400 40)").attr("fill", "green");

      this.svgSelection.append("path").attr("d", d3.symbol().type(d3.symbolTriangle).size(1000)).attr("transform", "translate(280 40)").attr("fill", "blue");

      this.svgSelection.append("path").attr("d", d3.symbol().type(d3.symbolCircle).size(1000)).attr("transform", "translate(160 40)").attr("fill", "purple");

      this.svgSelection.append("path").attr("d", d3.symbol().type(d3.symbolCross).size(1000)).attr("transform", "translate(480 40)").attr("fill", "yellow");

      this.svgSelection.append("path").attr("d", d3.symbol().type(d3.symbolSquare).size(1000)).attr("transform", "translate(580 40)").attr("fill", "brown");

      this.svgSelection.append("path").attr("d", d3.symbol().type(d3.symbolStar).size(1000)).attr("transform", "translate(680 40)").attr("fill", "red");

      this.svgSelection.append("path").attr("d", d3.symbol().type(d3.symbolWye).size(1000)).attr("transform", "translate(160 145)").attr("fill", "orange");
      ...
      this.svgSelection.append("path").attr("d", context.toString()).attr("transform", "translate(260 120)").attr("fill", "orange");
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement("canvas", { style: { flex: 0 }, ref: "canvas" })
        )
      );
    }
  }]);
...
exports.default = (0, _reactRouter.withRouter)(BasicShapes);
...
/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(101); if (makeExportsHot(module, __webpack_require__(2))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "BasicShapes.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
